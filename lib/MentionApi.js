...
function MentionApi(options) {
  ...
  return new RequestFactory([
    ...
    [
      ...
      { post: Joi.object().keys({
                name: Joi.string().required(),
                included_keywords: Joi.array().includes(Joi.string()).optional(),
                required_keywords: Joi.array().includes(Joi.string()).optional(),
                excluded_keywords: Joi.array().includes(Joi.string()).optional(),
                primary_keyword: Joi.array().includes(Joi.string()).optional().tags(['deprecated']),
                languages: Joi.array().includes(Joi.string().min(2).max(2).lowercase()).required(),
                countries: Joi.array().includes(Joi.string().min(2).max(2).uppercase()).required(),
                sources: Joi.array().includes(Joi.string()).required(),
    ...
    [
      ...
      { put: Joi.object().keys({
               ...
               excluded_keywords: Joi.array().includes(Joi.string()).optional(),
               primary_keyword: Joi.array().includes(Joi.string()).optional().tags(['deprecated']),
               languages: Joi.array().includes(Joi.string().min(2).max(2).lowercase()).optional(),
               countries: Joi.array().includes(Joi.string().min(2).max(2).uppercase()).optional(),
               sources: Joi.array().includes(Joi.string()).optional(),
               blocked_sites: Joi.array(Joi.string()).optional(),
               noise_detection: Joi.boolean().optional(),
             })
               .required()
    ...
    [
      ...
      { get: Joi.object().keys({
               ...
               source: Joi.array().includes(Joi.string()).optional(),
